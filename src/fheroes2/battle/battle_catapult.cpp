...
int Battle::Catapult::GetDamage( std::mt19937 & randomGenerator ) const
{
...
Battle::CastleDefenseStructure Battle::Catapult::GetTarget( const std::map<CastleDefenseStructure, int> & stateOfCatapultTargets, std::mt19937 & randomGenerator )
{
...
bool Battle::Catapult::IsNextShotHit( std::mt19937 & randomGenerator ) const
{
    // Miss chance is 25%
