...
void Battle::Unit::SetRandomMorale( std::mt19937 & randomGenerator )
{
...
void Battle::Unit::SetRandomLuck( std::mt19937 & randomGenerator )
{
...
uint32_t Battle::Unit::GetDamage( const Unit & enemy, std::mt19937 & randomGenerator ) const
{
    uint32_t res = 0;
...
Spell Battle::Unit::GetSpellMagic( std::mt19937 & randomGenerator ) const
{
    const std::vector<fheroes2::MonsterAbility> & abilities = fheroes2::getMonsterData( GetID() ).battleStats.abilities;
